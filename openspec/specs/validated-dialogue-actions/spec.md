# validated-dialogue-actions Specification

## Purpose
Define the separation between language understanding and validated business actions, including authoritative references and explicit confirmation boundaries.
